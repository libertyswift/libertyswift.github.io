...
//--Menu-active--
    ...
    var count = $('.for-gullery-1 .photo').length
    var count2 = $('.for-gullery-2 .photo').length
    var count3 = $('.for-gullery-3 .photo').length
    $('.for-gullery-1 .number').text(count);
    $('.for-gullery-2 .number').text(count2);
    $('.for-gullery-3 .number').text(count3);
        if (count < 2){
            $('.for-gullery-1 .quantity').css("display", "none");
        }
        else {
           $('.for-gullery-1 .quantity').css("display", "block"); 
        }
        if (count2 < 2){
            $('.for-gullery-2 .quantity').css("display", "none");
        }
        else {
           $('.for-gullery-2 .quantity').css("display", "block"); 
        }
        if (count3 < 2){
            $('.for-gullery-3 .quantity').css("display", "none");
        }
        else {
           $('.for-gullery-3 .quantity').css("display", "block"); 
        }
	$('#txtPhone').inputmask("+7(999)-999-9999");
	$('.mobil-menu-block').click (function(){
	...
	$('.prise-block a').click(function(){
		var textInfo = $(this).parent('.item-li').find('.left-info').text();
		$('#myform textarea').val(textInfo);
        autosize();
	});  
...
$(document).on('submit', function(){
	if (validatePhone('txtPhone') == true) {
		event.preventDefault();
    $.ajax({
      type: 'POST',
      ...
      beforeSend: function(data) {
        $('.form-block').animate({opacity: '0'}, 100);
				$('.call .circle').animate({opacity: '1'}, 100);
				$('#apply').hide();
      },
			success: function(data) {
                setTimeout(function(){
                    $('.call .circle-anim, .call .circle-anim-red').css('display', 'none');
                    $('.call .circle img').css('display', 'block');
                }, 1500);
      },
      error: function(data) {
...
$(document).ready(function() {
    $('.for-gullery-1, .for-gullery-2, .for-gullery-3').lightGallery({
    selector: '.photo',
    thumbnail:true,
    fullScreen:true,
//    autoplay:true,
...
$(document).ready(function() {
        $('.button-anim-black, .button-anim-withe, .prise .apply').bind("click", function(e){
            var anchor = $(this);
